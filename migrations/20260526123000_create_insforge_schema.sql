-- Migration: Create InsForge core schema for Nibook
-- Generated: 2026-05-26 12:30:00

create extension if not exists "pgcrypto";

-- profiles (merchant / business)
...
-- availability blackouts (exceptions)
...
-- booking rules (buffer, min notice, max advance)
...
-- workspace settings (per merchant)
...
-- placeholder trigger to keep updated_at current
